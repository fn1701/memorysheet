...
\def\borderthickness{1pt}
\def\spacerthickness{1pt}
...
\DeclareDocumentCommand{\memorysheetpage}{}{
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \foreach [count=\j]\i in {0,\bereichsbreite,...,\paperwidth} {
            % \ifnum\j<8\relax
            \draw[vspacercolor,line width=\spacerthickness]([xshift=\i,yshift=0cm]mempage.north west)--([xshift=\i]mempage.south west);
            % \fi
        }
